...
pub fn less_than_builtin(interp: &mut Interpreter) -> Result<(), RuntimeError> {
...
mod tests {
    ...
    fn test_less_than_true() {
        ...
        less_than_builtin(&mut interp).unwrap();
    ...
    #[test]
    fn test_less_than_stack_underflow() {
        let mut interp = setup_interpreter();

        let result = less_than_builtin(&mut interp);
